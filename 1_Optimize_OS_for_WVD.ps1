 ...
 Write-output 'AIB Customization: OS Optimizations for WVD'
 $appName = 'optimize'
 $drive = 'C:\'
 ...
 Write-output 'AIB Customization: Starting OS Optimizations script'
 ...
 Write-output 'AIB Customization: Finished OS Optimizations script'
